<template>
  	<div class="content" id="Jreworp">
  		<header class="head">
			...
			<h1 class="y-confirm-order-h1">新增地址</h1>
			<span class="mail" @click="addConsignee">保存</span>
		</header>
		<div class="main">
				...
				<ul>
					...
					<li>
						<a href="javascript:;">
							<span>地址</span>
							<i></i>
							<input type="text" name="" readonly="readonly" id="JLAreaclick">
						</a>
