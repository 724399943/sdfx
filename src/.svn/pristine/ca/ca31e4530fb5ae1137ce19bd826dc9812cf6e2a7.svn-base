                    ...
                    <swiper auto height="200px" dots-position="center">
					    <template v-for="(it,index) in adimgList ">
					    	<swiper-item class="black" >
					    		<router-link :to="{path:'/bannerDetail',query:{id:it.id,sign:it.sign}}" v-if="it.type == 0">
					    			<img class="Sw-img" :src="it.image">
					    		</router-link>
					    		<a :href="it.url" v-else-if="it.type == 1">
					    			<img class="Sw-img" :src="it.image">
					    		</a>
					    		<router-link :to="{path:'/goodsDetail',query:{id:it.goods_id}}" v-else-if="it.type == 2">
					    			<img class="Sw-img" :src="it.image">
					    		</router-link>
					    		<router-link :to="{path:'/special',query:{sign:it.sign}}" v-else-if="it.type == 3">
					    			<img class="Sw-img" :src="it.image">
					    		</router-link>
					    	</swiper-item>
					    </template>
