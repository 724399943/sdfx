  			...
  			<div class="u-top">
				...
				<div class="u-top-wrap" v-if="is_sign == 1">
					<div class="u-top-user">
						...
						<p class="bt" v-else-if="userInfo.level == 1"><router-link to="/explain">VIP会员</router-link></p>
						<p class="bt" v-else-if="userInfo.level == 2"><router-link to="/explain">VIP金卡会员</router-link></p>
